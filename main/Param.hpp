...
public:
    ...
    virtual std::optional<int32_t> getI32(const char* key) = 0;
    virtual std::optional<uint32_t> getU32(const char* key) = 0;
    virtual std::optional<float> getFloat(const char* key) = 0;
